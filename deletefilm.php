...
// this is used for deleting films only
...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td background="images/edit/k4.png"></td><td background="images/edit/k5.png" bgcolor="#dee3cb">
			<div ID="innereditreq"><img src="images/attention.png" alt="attention" width="20" height="18" border="0">&nbsp;<?= $trans['alert_title'].$trans['delete_alert'].'<h4><b>'.htmlentities($movielocal).'</b></h4><br><h5><i>'.htmlentities($movietitle).'</i></h5>' ?></div>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr><td align="left">
		...
		<a target="mainframe" href="delete.php?fid=<?= $movieid ?>"><button name="delete" type="button" value="Delete" onClick="showRequest(false,'editreq','');">&nbsp;&nbsp;<b><?= $trans['b_delete']?></b>&nbsp;&nbsp;</button></a>
	</td></tr>
</table>
