...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td background="images/edit/k4.png"></td><td background="images/edit/k5.png" bgcolor="#dee3cb">
			<div ID="innereditreq"><img src="images/attention.png" alt="attention" width="20" height="18" border="0">&nbsp;<?= $trans['alert_title'].$trans['restore_dbase'].'<h2><b>'.$_GET['file']?></b></h2>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr><td align="left">
		...
		<button name="restore" type="button" value="Restore" onClick="ajaxpage('execute.php?script=res_dbase.php&info=l_res_dbase','editreqsource');">&nbsp;<b><?= $trans['b_restore']?></b>&nbsp;</button>
	</td></tr>
</table>
<? }else { ?>
<table border="0" cellpadding="0" cellspacing="0">
